...
type OwnProps = {
  ...
  onSubmit: (values: IAnnouncement, form: FormApi<IAnnouncement>) => Promise<IAnnouncement>;
};

type Props = OwnProps & WithStyles<typeof styles> & WithWidth;

class EditAnnouncementFormComponent extends React.PureComponent<Props> {
...
export const EditAnnouncementForm = withWidth()(withStyles(styles)(EditAnnouncementFormComponent));
