...
import { CommonReferenceFormFields } from './CommonReferenceFormFields';
...
type OwnProps = {
  initialValues: IReferenceForm;
  onSubmit: (values: IReferenceForm, form: FormApi<IReferenceForm>) => Promise<IReference>;
};

type Props = OwnProps & WithStyles<typeof styles> & WithWidth;

class AddReferenceFormComponent extends React.PureComponent<Props> {
          ...
          <Form initialValues={initialValues} onSubmit={handleSubmit}>
            {({ handleSubmit, submitting, values, invalid, pristine }) => (
              <form onSubmit={handleSubmit} noValidate>
                <DialogContent>
                  <CommonReferenceFormFields values={values} />
                </DialogContent>
                <DialogActions>
...
export const AddReferenceForm = withWidth()(withStyles(styles)(AddReferenceFormComponent));
