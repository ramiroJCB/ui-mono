...
type OwnProps = {
  ...
  onSubmit: (values: IReference, form: FormApi<IReference>) => Promise<IReference>;
};

type Props = OwnProps & WithStyles<typeof styles>;

class EditReferenceFormComponent extends React.PureComponent<Props> {
...
export const EditReferenceForm = withStyles(styles)(EditReferenceFormComponent);
