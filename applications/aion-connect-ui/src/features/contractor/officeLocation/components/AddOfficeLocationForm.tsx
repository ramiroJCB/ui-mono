...
type OwnProps = {
  initialValues: IOfficeLocationForm;
  onSubmit: (values: IOfficeLocationForm, form: FormApi<IOfficeLocationForm>) => Promise<IOfficeLocation>;
};

type Props = OwnProps & WithStyles<typeof styles> & WithWidth;

class AddOfficeLocationFormComponent extends React.PureComponent<Props> {
...
export const AddOfficeLocationForm = withWidth()(withStyles(styles)(AddOfficeLocationFormComponent));
