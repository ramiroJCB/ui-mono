...
type OwnProps = {
  ...
  onSubmit: (values: IProjectForm, form: FormApi<IProjectForm>) => Promise<IProject>;
};

type Props = OwnProps & WithStyles<typeof styles> & WithWidth;

class AddProjectFormComponent extends React.PureComponent<Props> {
...
export const AddProjectForm = withWidth()(withStyles(styles)(AddProjectFormComponent));
