...
type OwnProps = {
  initialValues: ICertificationForm;
  onSubmit: (values: ICertificationForm, form: FormApi<ICertificationForm>) => Promise<ICertification>;
};

type Props = OwnProps & WithStyles<typeof styles> & WithWidth;

class AddCertificationFormComponent extends React.PureComponent<Props> {
...
export const AddCertificationForm = withWidth()(withStyles(styles)(AddCertificationFormComponent));
