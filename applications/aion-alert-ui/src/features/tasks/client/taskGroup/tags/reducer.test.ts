import { initialState, reducer, State as TagsState } from './reducer';

let prevState: TagsState;
...
describe('Tags reducer', () => {
  it('updates state correctly when dispatching FETCH_TAGS_REQUEST', () => {
  ...
  it('updates state correctly when dispatching FETCH_TAGS_SUCCESS', () => {
    const contractors = [
      {
  ...
  it('updates state correctly when dispatching FETCH_TAGS_FAILURE', () => {
    const error = {
      name: 'Test Error',
      config: null,
