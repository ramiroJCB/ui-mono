...
type Props = InjectedFormProps<IIncidentCategory, OwnProps> & OwnProps;
...
const ClientCategoryFormComponent: React.FC<Props> = ({
  submitting,
  pristine,
  invalid,
  isFetching,
      ...
      <GridContainer alignItems="flex-start" justify="space-between">
        <Grid item>
          <Typography variant="h6" component="h2">
            {initialValues
              ? t('reporting.incidents.clientCategory.editClassification', 'Edit Classification')
...
export const ClientCategoryForm = reduxForm<IIncidentCategory, OwnProps>({
