...
type Props = InjectedFormProps<IIncidentType, OwnProps> & OwnProps;
...
const ClientTypeFormComponent: React.FC<Props> = ({
  submitting,
  pristine,
  invalid,
  isFetching,
      ...
      <GridContainer alignItems="flex-start" justify="space-between">
        <Grid item>
          <Typography variant="h6" component="h2">
            {initialValues
              ? t('reporting.incidents.clientType.editBehaviorCategory', 'Edit Behavior Category')
...
export const ClientTypeForm = reduxForm<IIncidentType, OwnProps>({
  form: 'clientTypeForm',
