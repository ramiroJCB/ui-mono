...
type Props = InjectedFormProps<IIncidentWorkGroup, OwnProps> & OwnProps;
...
const ClientWorkGroupFormComponent: React.FC<Props> = ({
  submitting,
  pristine,
  invalid,
  isFetching,
      ...
      <GridContainer alignItems="flex-start" justify="space-between">
        <Grid item>
          <Typography variant="h6" component="h2">
            {initialValues
              ? t('reporting.incidents.clientWorkGroup.editWorkGroup', 'Edit Work Group')
...
export const ClientWorkGroupForm = reduxForm<IIncidentWorkGroup, OwnProps>({
  form: 'clientWorkGroupForm',
  enableReinitialize: true,
  destroyOnUnmount: false
})(ClientWorkGroupFormComponent);
