...
const ContractorIncidentsRow: React.FC<Props> = ({
  classes,
      ...
      <AccordionSummary className={classes.summary} expandIcon={<ExpandMoreIcon />}>
        <Grid container spacing={3} justify="space-between" alignItems="center">
          ...
          <Grid item xs={4} zeroMinWidth>
            <Typography variant="body2" noWrap title={clientName}>
              {clientName}
            </Typography>
          </Grid>
...
export const ContractorIncidentsRowComponent = withStyles(styles)(ContractorIncidentsRow);
