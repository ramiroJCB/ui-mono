...
type Props = InjectedFormProps<IIncidentRootCause, OwnProps> & OwnProps;
...
const ClientRootCauseFormComponent: React.FC<Props> = ({
  submitting,
  pristine,
  invalid,
  isFetching,
      ...
      <GridContainer alignItems="flex-start" justify="space-between">
        <Grid item>
          <Typography variant="h6" component="h2">
            {initialValues
              ? t('reporting.incidents.clientRootCause.editRootCause', 'Edit Root Cause')
...
export const ClientRootCauseForm = reduxForm<IIncidentRootCause, OwnProps>({
  form: 'clientRootCauseForm',
  enableReinitialize: true,
  destroyOnUnmount: false
})(ClientRootCauseFormComponent);
