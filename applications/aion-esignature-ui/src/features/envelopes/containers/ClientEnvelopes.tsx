...
class Envelopes extends React.Component<Props> {
  constructor(props: Props) {
    ...
    props.fetchEnvelopesIfNeeded(true, organizationId);
  }
  ...
  componentDidUpdate({ location: { search: prevSearch } }: Props) {
    ...
    if (prevSearch !== search) {
      this.props.fetchEnvelopesIfNeeded(true, organizationId);
    }
  }
...
export const ClientEnvelopesContainer = connect(mapStateToProps, mapDispatchToProps)(Envelopes);
