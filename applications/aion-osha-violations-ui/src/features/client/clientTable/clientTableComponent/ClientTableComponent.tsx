...
import { IClientTableOption } from 'interfaces/clientTableOption';
...
export const ClientTableComponent: React.FC<Props> = ({
  handlePageChange,
                ...
                <TableCell colSpan={headers.length} style={{ height: 182 }}>
                  <Grid container spacing={2} direction="column" alignItems="center">
                    <Grid container item justify="center" xs={12}>
                      <ThumbUpIcon
                        style={{ height: 84, width: 94, alignSelf: 'center' }}
                        color="disabled"
                        fontSize="large"
                      />
                    </Grid>
